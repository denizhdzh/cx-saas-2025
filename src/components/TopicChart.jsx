    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          <div className="text-neutral-400 dark:text-neutral-500 text-sm mb-1">No topic data yet</div>
          <div className="text-neutral-300 dark:text-neutral-600 text-xs">Data will appear as conversations are analyzed</div>
        </div>
      </div>
    );
  }
